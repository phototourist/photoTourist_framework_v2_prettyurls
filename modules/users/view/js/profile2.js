    ...
    $("#dropzone").dropzone({
        ...
        removedfile: function(file, serverFileName) {
            ...
            $.ajax({
                ...
                //url: amigable("?module=users&function=delete_avatar&delete=true"),
                data: {
                    "filename": name,
                    "delete": true //en la función amigable esto sobra
                },
...
function load_countries_v1() {
    ...
    $.post("../users/load_countries_users/", {
                'load_country': true
            }, //el codigo ejemplo es por POST
            function(response) {
...
function load_provincias_v1() { //provinciasypoblaciones.xml - xpath
    ...
    $.post("../users/load_provinces_users/", {
                'load_provinces': true
            },
            function(response) {
                $("#provincia").empty();
