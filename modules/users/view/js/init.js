$(document).ready(function () {
    ...
    if (user) {
        ...
        if ( (user[2] === "worker") || (user[2] === "client")  ) {
            $("#LogProf").before("<li><a href=" + amigable('?module=camtourist') + ">Mis fotos</a></li>")
    ...
    if (url[6] === "activar" && url[7].substring(0, 3) == "Ver"){
        ...
        if (url[7] === "reg"){
            $("#alertbanner").html("<a href='#alertbanner' class='alertbanner'>PhotoTourist te ha enviado un email para verificar su cuenta</div>");
        }else if (url[7] === "rest"){
